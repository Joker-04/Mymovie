...
API_ID = int(environ.get('API_ID', '26206749'))
API_HASH = environ.get('API_HASH', ' 752db80f668272cbd097e1ec90b98c79')
BOT_TOKEN = environ.get('BOT_TOKEN', '8155744805:AAFFqumuTifi24jj-KCH1yvpJRUFYhWI_Yw')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002417525913'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/JisshuMovieZone')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002086541598').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://jayjoshi11105:fWGeHJmnrw3cf06A@cluster0.miwennb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002070573213')
